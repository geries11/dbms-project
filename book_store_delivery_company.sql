...
CREATE TABLE `delivery_company` (
  ...
  CONSTRAINT `company_id` FOREIGN KEY (`company_id`) REFERENCES `deliveries` (`deliveries_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `delivery_company` VALUES (1,'Xpress'),(2,'Israel-post');
